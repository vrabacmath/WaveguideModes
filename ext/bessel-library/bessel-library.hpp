...
inline int zbesj_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, int *ierr);
inline int zbesy_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, double *cwrkr, double *cwrki, int *ierr);
inline int zbesh_(double *zr, double *zi, double *fnu, int *kode, int *m, int *n, double *cyr, double *cyi, int *nz, int *ierr);
inline int zbesi_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, int *ierr);
inline int zbesk_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, int *ierr);
inline int zairy_(double *zr, double *zi, int *id, int *kode, double *air, double *aii, int *nz, int *ierr);
inline int zbiry_(double *zr, double *zi, int *id, int *kode, double *bir, double *bii, int *ierr);
// MAIN D. E. AMOS (SLATEC) ROUTINES DECLARATIONS
//-^------------------------------------------------------------------------
...
inline double zabs_(double *zr, double *zi);
inline int zexp_(double *ar, double *ai, double *br, double *bi);
inline int zdiv_(double *ar, double *ai, double *br, double *bi, double *cr, double *ci);
inline int zsqrt_(double *ar, double *ai, double *br, double *bi);
inline int zlog_(double *ar, double *ai, double *br, double *bi, int *ierr);
int zs1s2_(double *zrr, double *zri, double *s1r, double *s1i, double *s2r, double *s2i, int *nz, double *ascle, double *alim, int *iuf);
inline int zasyi_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *rl, double *tol, double *elim, double *alim);
inline int zacai_(double *zr, double *zi, double *fnu,	int *kode, int *mr, int *n, double *yr, double *yi, int *nz, double *rl, double *tol, double *elim,	double *alim);
...
inline int zbuni_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nui, int *nlast, double *fnul, double *tol, double *elim, double *alim);
inline int zmlri_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol);
inline int zmlt_(double *ar, double *ai, double *br, double *bi, double *cr, double *ci);
inline double dgamln_(double *z__, int *ierr);
inline int zseri_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol, double *elim, double *alim);
inline int zunik_(double *zrr, double *zri, double *fnu, int *ikflg, int *ipmtr, double *tol, int *init, double *phir, double *phii, double *zeta1r, double *zeta1i, double *zeta2r, double *zeta2i, double *sumr, double *sumi, double *cwrkr, double *cwrki);
inline int zunhj_(double *zr, double *zi, double *fnu, int *ipmtr, double *tol, double *phir, double *phii, double *argr, double *argi, double *zeta1r, double *zeta1i, double *zeta2r, double *zeta2i, double *asumr, double *asumi, double *bsumr, double *bsumi);
inline int zuchk_(double *yr, double *yi, int *nz, double *ascle, double *tol);
inline int zuoik_(double *zr, double *zi, double *fnu, int *kode, int *ikflg, int *n, double *yr, double *yi, int *nuf, double *tol, double *elim, double *alim);
inline int zbknu_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol, double *elim, double *alim);
inline int zrati_(double *zr, double *zi, double *fnu, int *n, double *cyr, double *cyi, double *tol);
inline int zwrsk_(double *zrr, double *zri, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *cwr, double *cwi, double *tol, double *elim, double *alim);
inline int zbinu_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, double *rl, double *fnul, double *tol, double *elim, double *alim);
inline int zshch_(double *zr, double *zi, double *cshr,	double *cshi, double *cchr, double *cchi);
inline int zkscl_(double *zrr, double *zri, double *fnu, int *n, double *yr, double *yi, int *nz, double *rzr, double *rzi, double *ascle, double *tol, double *elim);
inline int zacon_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz, double *rl, double *fnul, double *tol, double *elim, double *alim);
inline int zbunk_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz, double *tol, double *elim, double *alim);
...
inline int c__15 = 15;
inline int c__16 = 16;
inline double c_b10 = .5;
inline double c_b11 = 0.;
// TABLE OF GLOBAL CONSTANT VALUES
//-^------------------------------------------------------------------------
...
inline double d1mach_(int *c__n)
{
    switch(*c__n)
    {
        case 1:
...
/* DECK ZEXP */
/* Subroutine */
inline int zexp_(double *ar, double *ai, double *br, 
	double *bi)
{
    /* Local variables */
    double ca, cb, zm;
...
/* DECK ZDIV */
/* Subroutine */
inline int zdiv_(double *ar, double *ai, double *br, 
...
/* DECK ZSQRT */
/* Subroutine */
inline int zsqrt_(double *ar, double *ai, double *br, 
	double *bi)
{
    /* Initialized data */
...
/* DECK ZLOG */
/* Subroutine */
inline int zlog_(double *ar, double *ai, double *br, 
	double *bi, int *ierr)
{
    /* Initialized data */
    double dpi = 3.141592653589793238462643383;
...
/* DECK ZS1S2 */
/* Subroutine */
inline int zs1s2_(double *zrr, double *zri, double *s1r,
...
/* DECK ZASYI */
/* Subroutine */
inline int zasyi_(double *zr, double *zi, double *fnu, 
...
/* DECK ZACAI */
/* Subroutine */
inline int zacai_(double *zr, double *zi, double *fnu, 
...
/* DECK ZUNI1 */
/* Subroutine */
inline int zuni1_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *yr, double *yi, int *
...
/* DECK ZUNI2 */
/* Subroutine */
inline int zuni2_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *yr, double *yi, int *
	nz, int *nlast, double *fnul, double *tol, double *
	elim, double *alim)
{
...
/* DECK ZBUNI */
/* Subroutine */
inline int zbuni_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *yr, double *yi, int *
...
/* DECK ZMLRI */
/* Subroutine */
inline int zmlri_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *yr, double *yi, int *
	nz, double *tol)
{
    /* Initialized data */
...
/* DECK ZMLT */
/* Subroutine */
inline int zmlt_(double *ar, double *ai, double *br, 
	double *bi, double *cr, double *ci)
{
    double ca, cb;
...
/* DECK ZSERI */
/* Subroutine */
inline int zseri_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *yr, double *yi, int *
...
/* DECK ZUNIK */
/* Subroutine */
inline int zunik_(double *zrr, double *zri, double *fnu,
...
/* DECK ZUNHJ */
/* Subroutine */
inline int zunhj_(double *zr, double *zi, double *fnu, 
...
/* DECK ZUCHK */
/* Subroutine */
inline int zuchk_(double *yr, double *yi, int *nz, 
...
/* DECK ZUOIK */
/* Subroutine */
inline int zuoik_(double *zr, double *zi, double *fnu, 
...
/* DECK ZBKNU */
/* Subroutine */
inline int zbknu_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *yr, double *yi, int *
	nz, double *tol, double *elim, double *alim)
{
    /* Initialized data */
...
/* DECK ZRATI */
/* Subroutine */
inline int zrati_(double *zr, double *zi, double *fnu, 
...
/* DECK ZWRSK */
/* Subroutine */
inline int zwrsk_(double *zrr, double *zri, double *fnu,
	 int *kode, int *n, double *yr, double *yi, int *
...
/* DECK ZBINU */
/* Subroutine */
inline int zbinu_(double *zr, double *zi, double *fnu, 
...
/* DECK ZSHCH */
/* Subroutine */
inline int zshch_(double *zr, double *zi, double *cshr, 
...
/* DECK ZKSCL */
/* Subroutine */
inline int zkscl_(double *zrr, double *zri, double *fnu,
...
/* DECK ZACON */
/* Subroutine */
inline int zacon_(double *zr, double *zi, double *fnu, 
	int *kode, int *mr, int *n, double *yr, double *
...
/* DECK ZBUNK */
/* Subroutine */
inline int zbunk_(double *zr, double *zi, double *fnu, 
	int *kode, int *mr, int *n, double *yr, double *
...
/* DECK ZUNK1 */
/* Subroutine */
inline int zunk1_(double *zr, double *zi, double *fnu, 
	int *kode, int *mr, int *n, double *yr, double *
	yi, int *nz, double *tol, double *elim, double *alim)
{
    /* Initialized data */
    ...
    double zeta1i[2], zeta2i[2], zet1di, zet2di, zeta1r[2], zeta2r[
	    2], zet1dr, zet2dr;
...
/* DECK ZUNK2 */
/* Subroutine */
inline int zunk2_(double *zr, double *zi, double *fnu, 
	int *kode, int *mr, int *n, double *yr, double *
	yi, int *nz, double *tol, double *elim, double *alim)
{
    /* Initialized data */
...
/* DECK ZBESJ */
/* Subroutine */
inline int zbesj_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *cyr, double *cyi, int *
	nz, int *ierr)
{
    /* Initialized data */
...
/* DECK ZBESY */
/* Subroutine */
inline int zbesy_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *cyr, double *cyi, int *
	nz, double *cwrkr, double *cwrki, int *ierr)
{
    ...
    int nz1, nz2;
    double exi, r1m5, exr, sti, tay, tol, str, hcii, elim, atol, 
	    rtol, ascle;
...
/*         ints the function changes radically.  When a is a large */
/*         positive half odd int, the magnitude of Y(-a,z)=J(a,z)* */
/*         sin(a*pi) is a large negative power of ten.  But when a is */
/*         not a half odd int, Y(a,z) dominates in magnitude with a */
...
/*         half odd int.  Here, large means a>abs(z). */
...
/* DECK ZBESH */
/* Subroutine */
inline int zbesh_(double *zr, double *zi, double *fnu, 
...
/* DECK ZBESI */
/* Subroutine */
inline int zbesi_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *cyr, double *cyi, int *
	nz, int *ierr)
{
    /* Initialized data */
...
/*         can be used.  However, for large orders close to ints the */
/*         the function changes radically.  When a is a large positive */
/*         int, the magnitude of I(-a,z)=I(a,z) is a large */
/*         negative power of ten. But when a is not an int, */
...
/* DECK ZBESK */
/* Subroutine */
inline int zbesk_(double *zr, double *zi, double *fnu, 
	int *kode, int *n, double *cyr, double *cyi, int *
	nz, int *ierr)
{
    /* System generated locals */
...
/* DECK ZAIRY */
/* Subroutine */
inline int zairy_(double *zr, double *zi, int *id, 
...
/*         U3=I1MACH(9)=LARGEST int.  Thus, the magnitude of ZETA */
...
/* DECK ZBIRY */
/* Subroutine */
inline int zbiry_(double *zr, double *zi, int *id, 
...
//-v------------------------------------------------------------------------
// C++ AMOS/SLATEC FLAGS
inline void _flag_zbesj_(const int _ierr, const int _nz)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zbesj_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zbesj_] Flag -> Overflow: No computation, imag(_z) too large on nonscaled calculation." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zbesj_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zbesj_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because of complete losses of significance by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zbesj_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
    if (_nz != 0) std::cerr << "[bessel::slatec::zbesj_] Flag -> Number of components set to zero due to underflow: " << _nz << "." << std::endl;
}
inline void _flag_zbesy_(const int _ierr, const int _nz)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zbesy_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zbesy_] Flag -> Overflow: No computation, abs(_nu) too large or abs(_z) is too small or both." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zbesy_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zbesy_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because of complete losses of significance by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zbesy_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
    if (_nz != 0) std::cerr << "[bessel::slatec::zbesy_] Flag -> Number of components set to zero due to underflow: " << _nz << "." << std::endl;
}
inline void _flag_zbesh_(const int _ierr, const int _nz)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zbesh_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zbesh_] Flag -> Overflow: No computation, abs(_nu) too large or abs(_z) too small or both." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zbesh_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zbesh_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because of complete losses of significance by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zbesh_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
    if (_nz != 0) std::cerr << "[bessel::slatec::zbesh_] Flag -> Number of components set to zero due to underflow: " << _nz << "." << std::endl;
}
inline void _flag_zbesi_(const int _ierr, const int _nz)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zbesi_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zbesi_] Flag -> Overflow: No computation, real(_z) too large on nonscaled calculation." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zbesi_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zbesi_] Flag -> The abs(z) or abs(_nu)+_n-1 too large: No computation because of complete losses of significance by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zbesi_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
    if (_nz != 0) std::cerr << "[bessel::slatec::zbesi_] Flag -> Number of components set to zero due to underflow: " << _nz << "." << std::endl;
}
inline void _flag_zbesk_(const int _ierr, const int _nz)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zbesk_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zbesk_] Flag -> Overflow: No computation, abs(_nu) is too large or abs(_z) is too small or both." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zbesk_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zbesk_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because of complete losses of significance by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zbesk_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
    if (_nz != 0) std::cerr << "[bessel::slatec::zbesk_] Flag -> Number of components set to zero due to underflow: " << _nz << "." << std::endl;
}
inline void _flag_zairy_(const int _ierr, const int _nz)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zairy_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zairy_] Flag -> Overflow: No computation, real((2/3)*_z*sqrt(_z)) is too large on nonscaled calculation." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zairy_] Flag -> The abs(_z) large: Computation completed, losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zairy_] Flag -> The abs(_z) too large: No computation, complete loss of accuracy by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zairy_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
    if (_nz != 0) std::cerr << "[bessel::slatec::zairy_] Flag -> Result set to zero due to underflow in -pi/3 < arg(_z) < pi/3." << std::endl;
}
inline void _flag_zbiry_(const int _ierr)
{
    ...
    switch(_ierr)
    {
        case 0:
            break;
        case 1:
            std::cerr << "[bessel::slatec::zbiry_] Flag -> Input error: No computation." << std::endl;
            break;
        case 2:
            std::cerr << "[bessel::slatec::zbiry_] Flag -> Overflow: No computation, real(_z) is too large on nonscaled calculation." << std::endl;
            break;
        case 3:
            std::cerr << "[bessel::slatec::zbiry_] Flag -> The abs(_z) large: Computation completed, losses of signifcance by argument reduction produce less than half of machine accuracy." << std::endl;
            break;
        case 4:
            std::cerr << "[bessel::slatec::zbiry_] Flag -> The abs(_z) too large: No computation, complete loss of accuracy by argument reduction." << std::endl;
            break;
        case 5:
            std::cerr << "[bessel::slatec::zbiry_] Flag -> Error: No computation, algorithm termination condition not met." << std::endl;
            break;
    }
}
// C++ AMOS/SLATEC FLAGS
...
template<typename T1, typename T2>
inline void cyl_j( const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> * _cyl_j, bool _scaled = false, bool _flags = false )
{
    // Parameters
...
template<typename T1, typename T2>
inline void cyl_j( const T1 _nu, const int _n, T2 _z, T2 * _cyl_j, bool _scaled = false, bool _flags = false )
{
...
template<typename T1, typename T2>
inline void cyl_y( const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> * _cyl_y, bool _scaled = false, bool _flags = false )
{
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
...
template<typename T1, typename T2>
inline void cyl_y( const T1 _nu, const int _n, T2 _z, T2 * _cyl_y, bool _scaled = false, bool _flags = false )
{
...
// COMMENTED OUT - Hankel functions must return complex values: template<typename T1, typename T2>
// COMMENTED OUT - Hankel functions must return complex values: T2 cyl_h1( const T1 _nu, const T2 _z, bool _scaled = false, bool _flags = false )
// COMMENTED OUT - Hankel functions must return complex values: {
// COMMENTED OUT - Hankel functions must return complex values:     return real( cyl_h1( _nu, std::complex<T2>(_z,0.), _scaled, _flags ) ) ;
// COMMENTED OUT - Hankel functions must return complex values: }
...
// COMMENTED OUT - Hankel functions must return complex values: template<typename T1, typename T2>
// COMMENTED OUT - Hankel functions must return complex values: T2 cyl_h2( const T1 _nu, const T2 _z, bool _scaled = false, bool _flags = false )
// COMMENTED OUT - Hankel functions must return complex values: {
// COMMENTED OUT - Hankel functions must return complex values:     return real( cyl_h2( _nu, std::complex<T2>(_z,0.), _scaled, _flags ) ) ;
// COMMENTED OUT - Hankel functions must return complex values: }
...
template<typename T1, typename T2>
inline void cyl_i( const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> * _cyl_i, bool _scaled = false, bool _flags = false )
{
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
...
template<typename T1, typename T2>
inline void cyl_i( const T1 _nu, const int _n, T2 _z, T2 * _cyl_i, bool _scaled = false, bool _flags = false )
{
...
template<typename T1, typename T2>
inline void cyl_k( const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> * _cyl_k, bool _scaled = false, bool _flags = false )
{
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
...
template<typename T1, typename T2>
inline void cyl_k( const T1 _nu, const int _n, T2 _z, T2 * _cyl_k, bool _scaled = false, bool _flags = false )
{
